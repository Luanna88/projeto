...
public class CriarTabela extends JFrame  {
	...
	public CriarTabela(){
		...
		String sentencaSQL = "CREATE TABLE tabelaFilmes (ID Serial PRIMARY KEY, título VARCHAR(255),ano INT,avaliacao DOUBLE PRECISION);" ;
		...
		JLabel mensagem = new JLabel("Você criou a tabela filmes usando o CREATE TABLE!");
		P.add(mensagem);
	}
