...
public class SelecionarDados extends JFrame {
	...
	public SelecionarDados() throws SQLException{
		...
		try{
			...
			ResultSet resultSet = st.executeQuery("SELECT * FROM tabelaFilmes;");
			//processa resultados da consulta
			ResultSetMetaData metaData = resultSet.getMetaData();
			int numberOfColumns = metaData.getColumnCount();
			System.out.println("Relacao de Filmes Cadastrados!");
		...
		JLabel mensagem1 = new JLabel("Você  selecionou dados usando SELECT!");
